...
printASTIndented depth DeadLeafAST =
    indent depth ++ "DeadLeafAST\n"
printASTIndented depth (IntAST value) =
    indent depth ++ "IntAST " ++ show value ++ "\n"
printASTIndented depth (FloatAST value) =
    indent depth ++ "FloatAST " ++ show value ++ "\n"
printASTIndented depth (SymbolAST name) =
    indent depth ++ "SymbolAST " ++ name ++ "\n"
...
printASTIndented depth (ElseAST expr) =
    indent depth ++ "ElseAST\n" ++
        printASTIndented (depth + 1) expr
printASTIndented depth IntTypeAST =
    indent depth ++ "IntTypeAST\n"
printASTIndented depth FloatTypeAST =
    indent depth ++ "FloatTypeAST\n"
printASTIndented depth CharTypeAST =
    indent depth ++ "CharTypeAST\n"
printASTIndented depth StringTypeAST =
    indent depth ++ "StringTypeAST\n"
printASTIndented depth VoidTypeAST =
    indent depth ++ "VoidTypeAST\n"
printASTIndented depth (StringAST value) =
    indent depth ++"StringAST " ++ value ++ "\n"
printASTIndented depth (CharAST value) =
    indent depth ++ "CharAST '" ++ [value] ++ "'\n"
